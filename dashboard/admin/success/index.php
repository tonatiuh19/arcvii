...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	try {
		 ...
		 $mail->Port       = 469;                                    // TCP port to connect tos


			//Recipients
			$mail->setFrom('noreply@arcvii.com', 'Confirmacion de Pago arcvii: '.$reserva.'');
			$mail->addAddress(''.$correo.'', ''.$nombre.'');     // Add a recipient

			$mail->addReplyTo('dihola@arcvii.com', 'Informacion de Pagos');
			//$mail->addCC('cc@example.com');
			$mail->addBCC('payments@arcvii.com');
			...
			$mail->Body    = '<p>¡Hola '.$nombre.'!</p> <p>Tu referencia de pago es la siguiente: '.$referencia.'.</p><p>Para solicitar factura, favor de mandar datos de facturacion a: payments@arcvii.com.</p> <p>Saludos cordiales.<br>Equipo arcvii. <br>dihola@arcvii.com</p>';
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="https://www.instagram.com/arcvii_mx/">
