                                ...
                                <div class="col-sm-10">
                                  <form action="saving/" method="post">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="title" id="exampleFormControlInput1" value="'.$row["proyecto"].'" required>
																			<input type="hidden" class="form-control" name="idProject" id="exampleFormControlInput1" value="'.$id.'" >
                                    </div>

                                    <div class="form-group">
                                      <label for="exampleFormControlInput1">Precio:</label>
                                      <input type="number" class="form-control" name="price" id="exampleFormControlInput1" value="'.$row["precio"].'" required>
                                    </div>

                                    <div class="form-group">
                                      <label for="sel1">Tipo de proyecto:  <b>'.$row["titulo"].'</b></label>
                                      <select class="form-control" id="sel1" name="type">';

																			$sql2 = "SELECT id_project_type, titulo FROM project_type";
																			mysqli_set_charset($conn,'utf8');
																			...
																			if ($result2->num_rows > 0) {
																					...
																					while($row2 = $result2->fetch_assoc()) {
																							echo '<option value="'.$row2["id_project_type"].'">'.$row2["titulo"].'</option>';
																					}
																			} else {
																					echo "0 results";
																			}
                                    ...
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="5" required>'.$row["descripcion"].'</textarea>
                                    </div>
