...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 $cambio = test_input($_POST["cambio"]);
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $sql2 = "SELECT id_paquete, fecha_ida, fecha_vuelta, incluido, precio FROM paquetes where id_viaje='".$cambio."'";
        ...
        if ($result2->num_rows > 0) {
            ...
            while($row2 = $result2->fetch_assoc()) {
                ...
                echo "            <button type=\"submit\" class=\"btn btn-lg btn-block btn-outline-primary\">Cambiar</button><br>\n"; 
                echo "</form>\n";
