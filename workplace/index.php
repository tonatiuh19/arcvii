			...
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item">
							<a class="nav-link active" href="../workplace/">
				...
				<div id="1">
					<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						...
						<div class="btn-toolbar mb-2 mb-md-0">
							...
							<a href="projects/" class="btn btn-sm btn-outline-primary">Buscar Proyecto <i class="fas fa-plus-square"></i></a>
						</div>
					</div>
					<section class="bg-light" id="portfolio">
						...
						$sql2 = "SELECT a.id, a.id_project, a.status, max(a.date) as 'date', b.id_project_type, b.titulo, b.descripcion, b.precio, a.email_user, b.status FROM projects_candidates AS a inner join projects as b on a.id_project=b.id WHERE a.status=1 and b.status=1 and a.email_user='".$_SESSION['email']."' GROUP by a.id_project";
